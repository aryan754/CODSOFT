...
titanic_df = pd.read_csv(r'C:\Users\Admin\Downloads\TitanicDataset.csv')
...
titanic_test_data = pd.read_csv('C:/Users/Admin/Downloads/test.csv')
...
final_df.to_csv(r"C:\Users\Admin\Desktop\CodSoft DataScienceNot necessary\Titanic Survival Prediction\Predictions.csv", index=False)
